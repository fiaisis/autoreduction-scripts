...
LoadVesuvio(Filename=runno, SpectrumList=forward_scattering_spectra, Mode="SingleDifference", InstrumentParFile=filepath_ip, SumSpectra=True, OutputWorkspace=runno+"_front")
LoadVesuvio(Filename=runno, SpectrumList=back_scattering_spectra, Mode="SingleDifference", InstrumentParFile=filepath_ip, SumSpectra=True, OutputWorkspace=runno+"_back_sd")
Minus(LHSWorkspace=runno+"_back_sd", RHSWorkspace="empty_back_sd", OutputWorkspace=runno+"_back_sd")
LoadVesuvio(Filename=runno, SpectrumList=back_scattering_spectra, Mode="DoubleDifference", InstrumentParFile=filepath_ip, SumSpectra=True, OutputWorkspace=runno+"_back_dd")
...
LoadVesuvio(Filename=runno, SpectrumList="135-182", Mode="FoilInOut", InstrumentParFile=filepath_ip, SumSpectra=True, OutputWorkspace=runno+"_gamma")
